...
<ore:dustPlatinum>.add(<industrialupgrade:crushed:9>);
...
<ore:dustBronze>.remove(<industrialupgrade:alloydust>);
...
<ore:dustAluminium>.remove(<thermalfoundation:material:68>);
